...
app.get("/editarDonacion:id", verificaToken, function(req, res) {
...
app.get("/eliminarDonacion:id", verificaToken, function(req, res) {
    let id = req.params.id;
    id = id.substr(1, id.length - 1);
    let body = req.body;
...
app.get("/info-donaciones:id", verificaToken, function(req, res) {
    let id = req.params.id;
    id = id.substr(1, id.length - 1);
    let body = req.body;
